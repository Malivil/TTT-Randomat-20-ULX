...
local function init()
    if GetConVarString("gamemode") == "terrortown" then --Only execute the following code if it's a terrortown gamemode
        ...
        table.insert(commands, "ttt_randomat_murder")
        table.insert(commands, "ttt_randomat_pocket")
        ...
        table.insert(commands, "randomat_murder_pickups_pct")
        table.insert(commands, "randomat_murder_knifespeed")
        ...
        table.insert(commands, "ttt_randomat_gravity")
        table.insert(commands, "randomat_gravity_timer")
        table.insert(commands, "randomat_gravity_duration")
...
hook.Add("PlayerInitialSpawn", "sendCombinedULXEventsTable", function( ply )
    ...
    timer.Create("sendULXDelay", 1, 1, function()
...
util.AddNetworkString("FindRandomatAddons")
